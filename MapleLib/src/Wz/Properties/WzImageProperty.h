...
namespace Wz
{
	class AURORA_MAPLE_API WzImageProperty : public WzObject
	{
		public:
			...
			WzImage GetParentImage() { return m_ParentImage; }
			WzPropertyType GetPropertyType() { return m_PropertyType; }
			WzImageProperties GetWzProperties() { return m_WzProperties; }
