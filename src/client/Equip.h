...
public:
    ...
    Equip(Equip && other) 
    {
        this->setUpgradeSlots(other.getUpgradeSlots());
        this->setLocked(other.getLocked());
        this->setRingId(other.getRingId());
        this->setLevel(other.getLevel());
        this->setJob(other.getJob());
        this->setHp(other.getHp());
        this->setMp(other.getMp());
        this->setStr(other.getStr());
        this->setDex(other.getDex());
        this->setInt(other.getInt());
        this->setLuk(other.getLuk());
        this->setWatk(other.getWatk());
        this->setMatk(other.getMatk());
        this->setWdef(other.getWdef());
        this->setMdef(other.getMdef());
        this->setAcc(other.getAcc());
        this->setAvoid(other.getAvoid());
        this->setHands(other.getHands());
        this->setSpeed(other.getSpeed());
        this->setJump(other.getJump());
    }
    Equip(Equip const& other)
    {
        this->setUpgradeSlots(other.getUpgradeSlots());
        this->setLocked(other.getLocked());
        this->setRingId(other.getRingId());
    ...
    Equip& operator=(Equip const& other)
    {
        this->setUpgradeSlots(other.getUpgradeSlots());
        this->setLocked(other.getLocked());
        this->setRingId(other.getRingId());
    ...
    inline u32 getItemType() { return Constants::ItemType::k_EQUIP; }
