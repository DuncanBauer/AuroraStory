...
namespace net
{
	...
	constexpr uint32_t k_wzOffsetConstant = 0x581C3F6D;

	// IV used to create the WzKey for GMS
	constexpr byte k_wzFileKeyIv[4] = { 0x4D, 0x23, 0xC7, 0x2B };
