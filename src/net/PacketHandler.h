...
namespace net
{
    namespace PacketHandler
    {
       ...
       void handleCharSelect(clientConnection client, Packet& packet);
        //static void handleCheckCharName(clientConnection client, Packet& packet);
        //static void handleCreateChar(clientConnection client, Packet& packet);
        //static void handleDeleteChar(clientConnection client, Packet& packet);
