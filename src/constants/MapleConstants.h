...
namespace Constants
{
    ...
    //namespace NXDataType
    //{
    //    constexpr u16 k_NONE    = 0;
    //    constexpr u16 k_INTEGER = 1;
    //    constexpr u16 k_DOUBLE  = 2;
    //    constexpr u16 k_STRING  = 3;
    //    constexpr u16 k_VECTOR  = 4;
    //    constexpr u16 k_BITMAP  = 5;
    //    constexpr u16 k_AUDIO   = 6;
    //};
